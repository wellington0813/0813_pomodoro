...
export function Home() {
    ...
    const currentSecound = activeCycle ? totalSecounds - amountSecoundsPassed : 0

    const minutesAmount = Math.floor(currentSecound / 60)
    const secondsAmount = currentSecound % 60
